...
function MainFooter() {
  return (
    <Center color={``} h={`full`} fontSize={`large`}>
      Created by Cesar Moros
      <Box paddingX={4}>
        <a href="https://github.com/Cmoros/ecommerce-ch">
          <svg
          ...
          {/* <svg
            className="toggle-svg__svg toggle-svg__svg--hover-show"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
